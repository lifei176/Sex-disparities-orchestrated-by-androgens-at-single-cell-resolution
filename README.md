...
2. Seurat_object_construction.R: The code in R to construct and integrate seurat objects.
3. DEG_definition.R: The code in R to define DEGs based on p-adjust < 0.05 and |Log2FC| > 0.5.
