...
#################1. Load data and creat seurat object
#################
#################
#################
#################
...
Adrenal <-merge(seurat_Adrenal_FD_1, y = c(seurat_Adrenal_FD_2,seurat_Adrenal_FS_1,seurat_Adrenal_FS_2,seurat_Adrenal_MC_1,seurat_Adrenal_MC_2,seurat_Adrenal_MS_1,seurat_Adrenal_MS_2,seurat_Adrenal_FD_3,seurat_Adrenal_FS_3,seurat_Adrenal_MC_3,seurat_Adrenal_MS_3), add.cell.ids = c("Adrenal_FD_1","Adrenal_FD_2","Adrenal_FS_1","Adrenal_FS_2","Adrenal_MC_1","Adrenal_MC_2","Adrenal_MS_1","Adrenal_MS_2","Adrenal_FD_3","Adrenal_FS_3","Adrenal_MC_3","Adrenal_MS_3"),project = "Adrenal")

#################2. Use no-integration method to evaluate the batch effect
#################
#################
#################
#################
...
Adrenal <- FindClusters(Adrenal, resolution = 0.10,verbose = TRUE)#11 clusters
Adrenal <- FindClusters(Adrenal, resolution = 0.20,verbose = TRUE)

pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Raw_UMAP_Adrenal.pdf",width=8,height=6)
DimPlot(Adrenal, reduction = "umap",cols = my36colors,raster=FALSE,label = TRUE)
dev.off()

pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Raw_UMAP_Adrenal_split.pdf",width=14,height=10)
DimPlot(Adrenal, reduction = "umap",cols = my36colors,raster=FALSE,split.by="orig.ident",ncol=4,label = TRUE)
dev.off()

pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Raw_Featureplot_QC.pdf",width=12,height=5)
FeaturePlot(Adrenal, features = c("nFeature_RNA", "nCount_RNA"),raster=FALSE,min.cutoff =0,reduction = "umap",cols= c("gray", "red"))
dev.off()

pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Raw_Vln_QC.pdf",width=20,height=6)
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Raw_cell_proportion_sample.pdf",width=10,height=4)
...
set.seed(100)
#################Adrenal_FD_1
n_Adrenal_FD_1 <- seurat_Adrenal_FD_1$nCount_RNA # identify total RNA count for each cell
l_Adrenal_FD_1 <- sort(n_Adrenal_FD_1)[2] # find the second least RNA count as the lower bound 
e_Adrenal_FD_1 <- emptyDrops(seurat_Adrenal_FD_1@assays$RNA@counts, lower = l_Adrenal_FD_1,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_FD_1_noempty <- seurat_Adrenal_FD_1[,which(e_Adrenal_FD_1$FDR <= 0.01)]# Remove potential empty droplets 7574
ncol(seurat_Adrenal_FD_1_noempty)/ncol(seurat_Adrenal_FD_1)#Calculate the percentage 0.91

#################Adrenal_FD_2
n_Adrenal_FD_2 <- seurat_Adrenal_FD_2$nCount_RNA # identify total RNA count for each cell
l_Adrenal_FD_2 <- sort(n_Adrenal_FD_2)[2] # find the second least RNA count as the lower bound 
e_Adrenal_FD_2 <- emptyDrops(seurat_Adrenal_FD_2@assays$RNA@counts, lower = l_Adrenal_FD_2,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_FD_2_noempty <- seurat_Adrenal_FD_2[,which(e_Adrenal_FD_2$FDR <= 0.01)]# Remove potential empty droplets 4441
ncol(seurat_Adrenal_FD_2_noempty)/ncol(seurat_Adrenal_FD_2)#Calculate the percentage 0.85

#################Adrenal_FS_1
n_Adrenal_FS_1 <- seurat_Adrenal_FS_1$nCount_RNA # identify total RNA count for each cell
l_Adrenal_FS_1 <- sort(n_Adrenal_FS_1)[2] # find the second least RNA count as the lower bound 
e_Adrenal_FS_1 <- emptyDrops(seurat_Adrenal_FS_1@assays$RNA@counts, lower = l_Adrenal_FS_1,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_FS_1_noempty <- seurat_Adrenal_FS_1[,which(e_Adrenal_FS_1$FDR <= 0.01)]# Remove potential empty droplets 6439
ncol(seurat_Adrenal_FS_1_noempty)/ncol(seurat_Adrenal_FS_1)#Calculate the percentage 0.96

#################Adrenal_FS_2
n_Adrenal_FS_2 <- seurat_Adrenal_FS_2$nCount_RNA # identify total RNA count for each cell
l_Adrenal_FS_2 <- sort(n_Adrenal_FS_2)[2] # find the second least RNA count as the lower bound 
e_Adrenal_FS_2 <- emptyDrops(seurat_Adrenal_FS_2@assays$RNA@counts, lower = l_Adrenal_FS_2,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_FS_2_noempty <- seurat_Adrenal_FS_2[,which(e_Adrenal_FS_2$FDR <= 0.01)]# Remove potential empty droplets 3005
ncol(seurat_Adrenal_FS_2_noempty)/ncol(seurat_Adrenal_FS_2)#Calculate the percentage 0.74

#################Adrenal_MC_1
n_Adrenal_MC_1 <- seurat_Adrenal_MC_1$nCount_RNA # identify total RNA count for each cell
l_Adrenal_MC_1 <- sort(n_Adrenal_MC_1)[2] # find the second least RNA count as the lower bound 
e_Adrenal_MC_1 <- emptyDrops(seurat_Adrenal_MC_1@assays$RNA@counts, lower = l_Adrenal_MC_1,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_MC_1_noempty <- seurat_Adrenal_MC_1[,which(e_Adrenal_MC_1$FDR <= 0.01)]# Remove potential empty droplets 4786
ncol(seurat_Adrenal_MC_1_noempty)/ncol(seurat_Adrenal_MC_1)#Calculate the percentage 0.58

#################Adrenal_MC_2
n_Adrenal_MC_2 <- seurat_Adrenal_MC_2$nCount_RNA # identify total RNA count for each cell
l_Adrenal_MC_2 <- sort(n_Adrenal_MC_2)[2] # find the second least RNA count as the lower bound 
e_Adrenal_MC_2 <- emptyDrops(seurat_Adrenal_MC_2@assays$RNA@counts, lower = l_Adrenal_MC_2,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_MC_2_noempty <- seurat_Adrenal_MC_2[,which(e_Adrenal_MC_2$FDR <= 0.01)]# Remove potential empty droplets 2627
ncol(seurat_Adrenal_MC_2_noempty)/ncol(seurat_Adrenal_MC_2)#Calculate the percentage 0.88

#################Adrenal_MS_1
n_Adrenal_MS_1 <- seurat_Adrenal_MS_1$nCount_RNA # identify total RNA count for each cell
l_Adrenal_MS_1 <- sort(n_Adrenal_MS_1)[2] # find the second least RNA count as the lower bound 
e_Adrenal_MS_1 <- emptyDrops(seurat_Adrenal_MS_1@assays$RNA@counts, lower = l_Adrenal_MS_1,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_MS_1_noempty <- seurat_Adrenal_MS_1[,which(e_Adrenal_MS_1$FDR <= 0.01)]# Remove potential empty droplets 2984
ncol(seurat_Adrenal_MS_1_noempty)/ncol(seurat_Adrenal_MS_1)#Calculate the percentage 0.65

#################Adrenal_MS_2
n_Adrenal_MS_2 <- seurat_Adrenal_MS_2$nCount_RNA # identify total RNA count for each cell
l_Adrenal_MS_2 <- sort(n_Adrenal_MS_2)[2] # find the second least RNA count as the lower bound 
e_Adrenal_MS_2 <- emptyDrops(seurat_Adrenal_MS_2@assays$RNA@counts, lower = l_Adrenal_MS_2,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_MS_2_noempty <- seurat_Adrenal_MS_2[,which(e_Adrenal_MS_2$FDR <= 0.01)]# Remove potential empty droplets 2474
ncol(seurat_Adrenal_MS_2_noempty)/ncol(seurat_Adrenal_MS_2)#Calculate the percentage 0.93

#################Adrenal_FD_3
n_Adrenal_FD_3 <- seurat_Adrenal_FD_3$nCount_RNA # identify total RNA count for each cell
l_Adrenal_FD_3 <- sort(n_Adrenal_FD_3)[2] # find the second least RNA count as the lower bound 
e_Adrenal_FD_3 <- emptyDrops(seurat_Adrenal_FD_3@assays$RNA@counts, lower = l_Adrenal_FD_3,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_FD_3_noempty <- seurat_Adrenal_FD_3[,which(e_Adrenal_FD_3$FDR <= 0.01)]# Remove potential empty droplets 5270
ncol(seurat_Adrenal_FD_3_noempty)/ncol(seurat_Adrenal_FD_3)#Calculate the percentage 0.97

#################Adrenal_FS_3
n_Adrenal_FS_3 <- seurat_Adrenal_FS_3$nCount_RNA # identify total RNA count for each cell
l_Adrenal_FS_3 <- sort(n_Adrenal_FS_3)[2] # find the second least RNA count as the lower bound 
e_Adrenal_FS_3 <- emptyDrops(seurat_Adrenal_FS_3@assays$RNA@counts, lower = l_Adrenal_FS_3,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_FS_3_noempty <- seurat_Adrenal_FS_3[,which(e_Adrenal_FS_3$FDR <= 0.01)]# Remove potential empty droplets 7668
ncol(seurat_Adrenal_FS_3_noempty)/ncol(seurat_Adrenal_FS_3)#Calculate the percentage 0.90

#################Adrenal_MC_3
n_Adrenal_MC_3 <- seurat_Adrenal_MC_3$nCount_RNA # identify total RNA count for each cell
l_Adrenal_MC_3 <- sort(n_Adrenal_MC_3)[2] # find the second least RNA count as the lower bound 
e_Adrenal_MC_3 <- emptyDrops(seurat_Adrenal_MC_3@assays$RNA@counts, lower = l_Adrenal_MC_3,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_MC_3_noempty <- seurat_Adrenal_MC_3[,which(e_Adrenal_MC_3$FDR <= 0.01)]# Remove potential empty droplets 10289
ncol(seurat_Adrenal_MC_3_noempty)/ncol(seurat_Adrenal_MC_3)#Calculate the percentage 0.94

#################Adrenal_MS_3
n_Adrenal_MS_3 <- seurat_Adrenal_MS_3$nCount_RNA # identify total RNA count for each cell
l_Adrenal_MS_3 <- sort(n_Adrenal_MS_3)[2] # find the second least RNA count as the lower bound 
e_Adrenal_MS_3 <- emptyDrops(seurat_Adrenal_MS_3@assays$RNA@counts, lower = l_Adrenal_MS_3,BPPARAM=MulticoreParam()) # identify potential empty droplets
seurat_Adrenal_MS_3_noempty <- seurat_Adrenal_MS_3[,which(e_Adrenal_MS_3$FDR <= 0.01)]# Remove potential empty droplets 8396
ncol(seurat_Adrenal_MS_3_noempty)/ncol(seurat_Adrenal_MS_3)#Calculate the percentage 0.87
...
#################4. Identify and remove doublets
#################
#################
#################
#################
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_FD_1.pdf",width=6,height=8)
...
seurat_Adrenal_FD_1_singlet<-subset(seurat_Adrenal_FD_1_high,doubletfinder=="Singlet")#6600
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_FD_2.pdf",width=6,height=8)
...
seurat_Adrenal_FD_2_singlet<-subset(seurat_Adrenal_FD_2_high,doubletfinder=="Singlet")#3731
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_FS_1.pdf",width=6,height=8)
...
seurat_Adrenal_FS_1_singlet<-subset(seurat_Adrenal_FS_1_high,doubletfinder=="Singlet")#5275
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_FS_2.pdf",width=6,height=8)
...
seurat_Adrenal_FS_2_singlet<-subset(seurat_Adrenal_FS_2_high,doubletfinder=="Singlet")#2583
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_MC_1.pdf",width=6,height=8)
...
seurat_Adrenal_MC_1_singlet<-subset(seurat_Adrenal_MC_1_high,doubletfinder=="Singlet")#4346
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_MC_2.pdf",width=6,height=8)
...
seurat_Adrenal_MC_2_singlet<-subset(seurat_Adrenal_MC_2_high,doubletfinder=="Singlet")#2342
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_MS_1.pdf",width=6,height=8)
...
seurat_Adrenal_MS_1_singlet<-subset(seurat_Adrenal_MS_1_high,doubletfinder=="Singlet")#2778
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_MS_2.pdf",width=6,height=8)
...
seurat_Adrenal_MS_2_singlet<-subset(seurat_Adrenal_MS_2_high,doubletfinder=="Singlet")#2218
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_FD_3.pdf",width=6,height=8)
...
seurat_Adrenal_FD_3_singlet<-subset(seurat_Adrenal_FD_3_high,doubletfinder=="Singlet")#4252
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_FS_3.pdf",width=6,height=8)
...
seurat_Adrenal_FS_3_singlet<-subset(seurat_Adrenal_FS_3_high,doubletfinder=="Singlet")#6442
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_MC_3.pdf",width=6,height=8)
...
seurat_Adrenal_MC_3_singlet<-subset(seurat_Adrenal_MC_3_high,doubletfinder=="Singlet")#8638
...
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/doublet/pK_Adrenal_MS_3.pdf",width=6,height=8)
...
seurat_Adrenal_MS_3_singlet<-subset(seurat_Adrenal_MS_3_high,doubletfinder=="Singlet")#6763
...
#################5.1 Merge data
Adrenal.combine <-merge(seurat_Adrenal_FD_1_singlet, y = c(seurat_Adrenal_FD_2_singlet,seurat_Adrenal_FS_1_singlet,seurat_Adrenal_FS_2_singlet,seurat_Adrenal_MC_1_singlet,seurat_Adrenal_MC_2_singlet,seurat_Adrenal_MS_1_singlet,seurat_Adrenal_MS_2_singlet,seurat_Adrenal_FD_3_singlet,seurat_Adrenal_FS_3_singlet,seurat_Adrenal_MC_3_singlet,seurat_Adrenal_MS_3_singlet), add.cell.ids = c("Adrenal_FD_1","Adrenal_FD_2","Adrenal_FS_1","Adrenal_FS_2","Adrenal_MC_1","Adrenal_MC_2","Adrenal_MS_1","Adrenal_MS_2","Adrenal_FD_3","Adrenal_FS_3","Adrenal_MC_3","Adrenal_MS_3"),project = "Adrenal.combine")
...
library(clustree)
pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Final_clustree_Adrenal.pdf",width=8,height=16)
...
pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Final_UMAP_Adrenal.pdf",width=8,height=6)
DimPlot(Adrenal.combine.integrated, reduction = "umap",cols = my36colors,raster=FALSE,label = TRUE)
dev.off()

pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Final_UMAP_Adrenal_split.pdf",width=14,height=10)
DimPlot(Adrenal.combine.integrated, reduction = "umap",cols = my36colors,raster=FALSE,split.by="orig.ident",ncol=4,label = TRUE)
dev.off()

pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Final_Featureplot_QC.pdf",width=12,height=5)
...
pdf("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Final_Vln_QC.pdf",width=20,height=6)
VlnPlot(Adrenal.combine.integrated, features = c("nFeature_RNA", "nCount_RNA","percent.mt"),group.by="orig.ident",pt.size=0.01)
dev.off()

saveRDS(Adrenal.combine.integrated,"/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Adrenal.combine.integrated.rds")
Adrenal.combine.integrated<-readRDS("/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Adrenal.combine.integrated.rds")

cell.prop.sample<-as.data.frame(prop.table(table(Idents(Adrenal.combine.integrated),Adrenal.combine.integrated$orig.ident)))
colnames(cell.prop.sample)<-c("cluster","sample","proportion")
pdf(file="/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Final_cell_proportion_sample.pdf",width=10,height=4)
ggplot(cell.prop.sample,aes(sample,proportion,fill=cluster))+
  geom_bar(stat="identity",position="fill")+
  ggtitle("")+
  theme_bw()+
...
write.csv(Adrenal.combine.integrated.markers,"/sibcb1/gaodonglab1/lifei/20230828_Revision/analysis/Adrenal/Adrenal.combine.integrated.markers.csv")
